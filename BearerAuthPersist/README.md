...
### Test
Use the attached [RapidAPI](https://paw.cloud)  [`My_Fav_Quotes_BearerAuth.paw`](My_Fav_Quotes_BearerAuth.paw) file.
...
|__POST__ | http://127.0.0.1:8080/api/v1/users/login | Login existing user and generate token |
|__GET__ | http://127.0.0.1:8080/api/v1/users/quotes | List all quotes of the current user |
